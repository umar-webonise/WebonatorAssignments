...
public class Java extends LanguageDetector {
	String file_content;
	public Java(String file_content) {
	...
	public void parse() throws IOException {
		...
		while(br.hasNext()){
			...
			Pattern patternMethod = Pattern.compile("(public |private |protected )?[ ]*[A-z0-9]+[ ]+([A-z$_][A-z0-9$_]*)[ ]*[(].*[)][ ]*[{]");
		    Pattern patternInstance = Pattern.compile("(public |private |protected )[ ]*[A-z0-9]+[ ]+([A-z$_][A-z0-9$_]*)[ ]*(=.*)?[;]");
	...
	public void indentation() {
		...
		while(s.hasNext()){
			...
			// System.out.println(line); //---Line Displays Unindented
